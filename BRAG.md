...
- The latest published prebuilt release (`v0.8-prebuilt`, built from `bd1d96e`) ships the desktop binary and a flashable board image so a new owner needs Python and a cable, nothing else.
