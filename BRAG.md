...
- The latest published prebuilt release (`v0.7-prebuilt`, built from `7f95313`) ships the desktop binary and a flashable board image so a new owner needs Python and a cable, nothing else.
