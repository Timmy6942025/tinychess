...
- The latest published prebuilt release (`v0.4-prebuilt`, built from `1d38015`) ships the desktop binary and a flashable board image so a new owner needs Python and a cable, nothing else.
